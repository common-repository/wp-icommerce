...
function wpic_custom_product_plugin_install(){
	global $plugin_custom_table_prefix;
	$plugin_custom_table_prefix = "wpic_";
}

function wpic_custom_product_plugin_uninstall(){

}

function wpic_create_upload_dir(){
	$upload = wp_upload_dir();
 	$get_upload_dir=$upload['basedir'].'/wpic_uploads/';
	if (!file_exists($get_upload_dir)) {
		mkdir($get_upload_dir, 0777, true);
	}
	if (!file_exists($get_upload_dir.'custom_images/')) {
		mkdir($get_upload_dir.'custom_images/', 0777, true);
	}
	if (!file_exists($get_upload_dir.'tmp/')) {
		mkdir($get_upload_dir.'tmp/', 0777, true);
	}
	if (!file_exists($get_upload_dir.'user_uploaded_images/')) {
		mkdir($get_upload_dir.'user_uploaded_images/', 0777, true);
	}
}

function _wpic_create_db_table(){
  global $wpdb;
  global $plugin_custom_table_prefix;
   ...
   */
  update_option('wpic_base_country',(get_option('wpic_base_country')?get_option('wpic_base_country'):'US'));
  update_option('wpic_origin_city',(get_option('wpic_origin_city')?get_option('wpic_origin_city'):'New York'));
  update_option('wpic_origin_postcode',(get_option('wpic_origin_postcode')?get_option('wpic_origin_postcode'):'10027'));
  update_option('wpic_base_currency',(get_option('wpic_base_currency')?get_option('wpic_base_currency'):'USD'));
  //update_option('wpic_admin_email',(get_option('wpic_admin_email')?get_option('wpic_admin_email'):''));
  update_option('wpic_base_tax',(get_option('wpic_base_tax')?get_option('wpic_base_tax'):0));
  update_option('wpic_design_help_text',(get_option('wpic_design_help_text')?get_option('wpic_design_help_text'):'Please enter help text'));
  update_option('wpic_product_per_page',(get_option('wpic_product_per_page')?get_option('wpic_product_per_page'):12));
  
  /*
   * wpicommerce order table
   */
	$table_name = $wpdb->prefix .$plugin_custom_table_prefix."order";
	$sql = "CREATE TABLE IF NOT EXISTS $table_name(
  `order_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_email` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_address1` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_address2` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_city` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_state` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_zip` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_country` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `billing_phone` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_email` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_address1` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_address2` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_city` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_state` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_zip` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_country` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_phone` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `payment_method` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_method` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_option` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `order_status` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `extra_charges` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `note` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `currency_code` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`order_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=0 ;";
	$wpdb->query($sql);
  
	/*
   * wpicommerce order item table
   */ 
	$table_name2 = $wpdb->prefix .$plugin_custom_table_prefix."order_item";
	$sql2 = "CREATE TABLE IF NOT EXISTS $table_name2(
    `order_item_id` bigint(20) NOT NULL AUTO_INCREMENT,
    `fk_order_id` bigint(20) DEFAULT NULL,
    `product_id` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
    `product_sku` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
    `product_title` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
    `product_qty` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
    `product_price` decimal(11,2) COLLATE utf8_unicode_ci DEFAULT NULL,
    `product_attribute` mediumtext COLLATE utf8_unicode_ci,
    `product_image` mediumtext COLLATE utf8_unicode_ci,
    `product_variation` mediumtext COLLATE utf8_unicode_ci,
    PRIMARY KEY (`order_item_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=0 ;";
	$wpdb->query($sql2);
  
  /*
   * wpicommerce currency list table
   */
  $table_name3 = $wpdb->prefix .$plugin_custom_table_prefix."currency_list";
  ...
  /*
   * wpicommerce currency default data
   */
  $currency_tbl_data = "INSERT INTO ".$table_name3." (id, country, isocode, currency, symbol, symbol_html, code, has_regions, tax, continent, visible) VALUES
...
(253, 'French Guiana', 'GF', 'Euro', '€', '&#8364;', 'EUR', '0', '0', 'southamerica', '1');";
  ...
  $tabledata = $wpdb->get_var( "SELECT COUNT(*) AS `count` FROM `" . $table_name3 . "`" );
  if ( $tabledata < 1 ) {
